  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const responses = {
        ...
        'projects': 'I\'ve built several impressive projects including PUP Guidance Center (web-based platform for PUP services), LiftFront Academy (gamified coding education platform), Palette of Eternity (digital arts platform), Elijah Gallery (photographic album platform), and VidQR (QR code generation tool). Each project showcases different aspects of my technical and creative abilities.',
