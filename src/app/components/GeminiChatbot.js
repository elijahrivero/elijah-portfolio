...
const GeminiChatbot = () => {
  ...
  const handleSendMessage = async () => {
    ...
    const responses = {
      ...
      'projects': 'Elijah has built several impressive projects including PUP Guidance Center (web application), RiveroBH (management system), Elijah Gallery (photography platform), Palette of Eternity (digital gallery), and VidQR (QR code generation tool).',
